...
Si una clase implementa una interfaz o clase abstracta, no debería añadir nuevos métodos públicos. De hecho, hay quien considera esto como un olor en el código.
