...
Enter quotas
create a defined goal for how much progress I needed to make in a predefined time period. I created a quota for everything I did that I needed to do more than once.
